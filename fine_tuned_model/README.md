...
* Approximate statistics based on the first 39 samples:
  ...
  |:--------|:----------------------------------------------------------------------------------|:----------------------------------------------------------------------------------|
  | type    | string                                                                            | string                                                                            |
  | details | <ul><li>min: 6 tokens</li><li>mean: 11.54 tokens</li><li>max: 17 tokens</li></ul> | <ul><li>min: 5 tokens</li><li>mean: 13.44 tokens</li><li>max: 24 tokens</li></ul> |
* Samples:
  | sentence_0                                                                          | sentence_1                                                                        |
  |:------------------------------------------------------------------------------------|:----------------------------------------------------------------------------------|
  | <code>How are students supported during their college application process?</code>   | <code>They meet regularly with the college counselor and faculty advisors.</code> |
  | <code>What kind of projects are done during the engineering portion of STEM?</code> | <code>Assistive technology devices designed and built for real clients.</code>    |
  | <code>Who teaches Wellness?</code>                                                  | <code>Ms. Liz.</code>                                                             |
